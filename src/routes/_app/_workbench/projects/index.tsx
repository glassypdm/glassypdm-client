...
function ProjectsIndex() {
  ...
  if (isPending) {
    ...
    return (
      <div>
        an error occurred while fetching data :c Check your Internet connection
      </div>
    )
      ...
      <div className="flex flex-col mr-16 space-y-2 items-center">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant={'outline'}
              disabled={data.body.managed_teams.length == 0}
            >
              Create Project
            </Button>
          </DialogTrigger>
          <DialogContent>
            {' '}
            {/** TODO this can/should be broken into its own component */}
            <DialogHeader>
            ...
            <DialogFooter className="place-items-center">
              ...
              <Button onClick={createProject} disabled={disableCreateProject}>
                Create
              </Button>
            </DialogFooter>
          </DialogContent>
                ...
                <CardContent className="justify-self-end flex flex-row space-x-4 items-center">
                  ...
                  <Button asChild>
                    <Link
                      ...
                      params={{ pid: project.id as string }}
                    >
                      Open
                    </Link>
                  </Button>
